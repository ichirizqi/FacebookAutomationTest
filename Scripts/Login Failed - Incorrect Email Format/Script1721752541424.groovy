...
WebUI.verifyElementVisible(findTestObject('Page_Facebook  log in or sign up/div_We couldnt find an account that matches what you entered, but weve found one that closely matches'))
